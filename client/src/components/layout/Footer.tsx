...
const Footer = () => {
  return (
    <footer className="bg-white text-black pt-16 pb-12 px-4 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex flex-col space-y-5">
            <Link to="/" className="w-24">
              <img src={logoBlack} alt="INTU00" className="w-full h-auto object-contain" />
            </Link>
            
            {/* Vietnamese Ministry of Industry and Trade Badge */}
            <a href="http://online.gov.vn/Home/WebDetails/112662" target="_blank" rel="noopener noreferrer" className="w-32">
              <img 
        ...
        <div className="flex flex-col space-y-6">
          ...
          <ul className="space-y-3 text-[11px] md:text-[12px] tracking-[0.1em] uppercase font-normal">
            ...
            <li>
              <Link to="/about" className="hover:opacity-60 transition-opacity flex items-center gap-2">
