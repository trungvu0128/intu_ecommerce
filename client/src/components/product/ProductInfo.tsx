...
const ProductInfo = ({ id, name, price, image, image2, sizes, description, styleId }: ProductInfoProps) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-12 px-4 md:px-8 bg-white text-black">
              ...
              <div className="absolute top-full left-0 w-full bg-white border border-black z-20 mt-[-1px]">
                {sizes.map((size) => (
                  <button
                    ...
                    className={cn(
                      "w-full text-left py-3 px-4 text-xs md:text-sm tracking-widest transition-colors hover:bg-zinc-50",
