...
const API_URL = import.meta.env.VITE_API_URL || 'http://localhost:5039';
...
const Register = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.message || 'Đăng ký thất bại hoặc email đã tồn tại');
      }
          ...
          {step === 1 ? (
            <div className="space-y-4">
              ...
              <div className="text-center pt-2">
                <Link to="/" className="text-[11px] text-[#999999] hover:text-black hover:underline underline-offset-4 transition-all inline-block border-b border-[#999999] hover:border-black pb-[1px] leading-none">
