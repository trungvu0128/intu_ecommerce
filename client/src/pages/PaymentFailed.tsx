    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 pt-28 pb-20">
        ...
        >
          ...
          {/* Error code */}
          <div className="inline-flex items-center gap-3 border border-red-200 bg-red-50 rounded px-5 py-2.5 mb-6">
            <span className="text-[11px] tracking-[0.15em] text-red-400 uppercase font-medium">
              Error:
            </span>
            <span className="text-[13px] tracking-[0.08em] font-bold text-red-600">
              {errorCode}
            </span>
          </div>
