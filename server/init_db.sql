...
CREATE TABLE "InventoryReasons" (
    ...
    "CreatedAt" timestamp with time zone NOT NULL,
    "UpdatedAt" timestamp with time zone,
    CONSTRAINT "PK_InventoryReasons" PRIMARY KEY ("Id")
);
...
CREATE TABLE "FeaturedSections" (
    ...
    CONSTRAINT "FK_FeaturedSections_Categories_CategoryId" FOREIGN KEY ("CategoryId") REFERENCES "Categories" ("Id") ON DELETE SET NULL
);
...
-- =============================================
-- Tables with FK to Orders / ProductVariants
-- =============================================
...
CREATE TABLE "InventoryTransactions" (
    ...
    CONSTRAINT "FK_InventoryTransactions_InventoryReasons_ReasonId" FOREIGN KEY ("ReasonId") REFERENCES "InventoryReasons" ("Id") ON DELETE SET NULL
);

-- =============================================
-- Tables with FK to Shipments
-- =============================================
...
CREATE INDEX "IX_FeaturedSections_CategoryId" ON "FeaturedSections" ("CategoryId");
CREATE INDEX "IX_InventoryTransactions_ProductVariantId" ON "InventoryTransactions" ("ProductVariantId");
CREATE INDEX "IX_InventoryTransactions_ReasonId" ON "InventoryTransactions" ("ReasonId");
